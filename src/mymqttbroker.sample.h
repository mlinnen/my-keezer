...
#define MQTT_TOPIC_PING  "/ha/keezer/ping"      // The topic that this devices listens for
#define MQTT_TOPIC_PINGR "/ha/keezer/pingr/1"   // The topic that this devices publishes as a response to a ping request
